...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander( // Base layout
    ...
    KC_TAB, KC_Q, KC_W, KC_F, KC_P, KC_G, KC_PSCR, KC_TRANSPARENT, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, BACKSLASH_HASH,
    KC_ESCAPE, MT(MOD_LGUI, KC_A),MT(MOD_LALT, KC_R),MT(MOD_LCTL, KC_S),MT(MOD_LSFT, KC_T), LT(2, KC_D), KC_INSERT, KC_TRANSPARENT, KC_H, MT(MOD_RSFT, KC_N),MT(MOD_RCTL, KC_E),MT(MOD_RALT, KC_I),MT(MOD_RGUI, KC_O),KC_MINUS,
